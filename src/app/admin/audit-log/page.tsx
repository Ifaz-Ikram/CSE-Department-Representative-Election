        ...
        <div className="min-h-screen circuit-bg">
            ...
            <main className="container mx-auto px-4 py-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* Date Range Filters */}
                    <div className="glass-card p-6 mb-8 animate-slide-up overflow-visible relative z-[45]">
                                ...
                                logs.map((log) => (
                                    <div key={log.id} className="glass-card p-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                                            <div>
                                                <p className="text-gray-500 text-xs uppercase tracking-wide mb-1">Actor</p>
                                            ...
                                            <div>
                                                <p className="text-gray-500 text-xs uppercase tracking-wide mb-1">Target</p>
                                        ...
                                        <div className="pt-3 border-t border-cyan/20">
                                            <p className="text-gray-500 text-xs uppercase tracking-wide mb-1">Details</p>
